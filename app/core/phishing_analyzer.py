...
class PhishingAnalyzer:
    ...
    # Reference URLs for security education
    REFERENCES = {
        ...
        "domain_spoofing": "https://www.ic3.gov/Media/Y2020/PSA200406",
        "social_engineering": "https://www.cisa.gov/topics/cybersecurity-best-practices/phishing",
        "url_shorteners": "https://www.consumer.ftc.gov/articles/how-recognize-and-avoid-phishing-scams"
    }
    ...
    def _check_urls(self, urls: List[str]):
        ...
        for url in urls[:10]:  # Limit to first 10 URLs
            ...
            # Add check based on domain analysis
    ...
    def _analyze_url(self, url: str) -> DomainAnalysis:
        ...
        try:
            ...
            shorteners = ['bit.ly', 'tinyurl.com', 'goo.gl', 't.co', 'ow.ly',
                         'is.gd', 'buff.ly', 'short.link', 'cutt.ly']
            ...
            for company in self.COMMONLY_SPOOFED:
                ...
                if company in domain:
                    ...
                    if company in official_domains:
                        if not any(official in domain for official in official_domains[company]):
                            checks.append(AnalysisCheck(
    ...
    def _check_impersonation(self, from_addr: str, body: str, subject: str):
        ...
        combined = (from_addr + ' ' + subject + ' ' + body).lower()
