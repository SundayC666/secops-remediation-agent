...
function renderPhishingResults(data) {
    ...
    const verdict = data.is_phishing ? 'PHISHING DETECTED' : 'LIKELY SAFE';
    const verdictColor = data.is_phishing ? 'var(--critical)' : 'var(--safe)';
    const verdictBg = data.is_phishing ? 'var(--powder-rose)' : 'var(--powder-sage)';
                            ...
                            <span class="info-tooltip risk-score-tooltip">
                                ...
                                <span class="tooltip-content risk-tooltip-content">
                                    ...
                                    <div class="risk-levels">
                                        <p style="margin: 0.25rem 0;"><span style="color: var(--safe); font-size: 1.1rem;">●</span> <strong>0-25:</strong> LOW</p>
                                        <p style="margin: 0.25rem 0;"><span style="color: var(--medium); font-size: 1.1rem;">●</span> <strong>26-50:</strong> MEDIUM</p>
                                        <p style="margin: 0.25rem 0;"><span style="color: var(--high); font-size: 1.1rem;">●</span> <strong>51-75:</strong> HIGH</p>
                                        <p style="margin: 0.25rem 0;"><span style="color: var(--critical); font-size: 1.1rem;">●</span> <strong>76-100:</strong> CRITICAL</p>
                                    </div>
                                </span>
                            </span>
                        </span>
